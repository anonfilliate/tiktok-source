...
var campaignID = "660bddcc343d88000137bc91";
...
var initialSrc = "https://track.earnoppcenter.net/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("track.earnoppcenter.net/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://track.earnoppcenter.net/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://track.earnoppcenter.net/view?clickid=" + rtkClickID)
        xhrTrack.send();
